...
const slides = [
  {
    ...
    content: {
      intro:
        "Penganggaran (budgeting) adalah proses merencanakan pendapatan dan pengeluaran Anda dalam periode tertentu. Ini adalah salah satu kebiasaan keuangan paling penting yang bisa Anda miliki.",
      ...
      closing:
        "Banyak orang merasa tidak perlu membuat anggaran karena merasa sudah tahu kemana uang mereka pergi. Namun kenyataannya, tanpa anggaran yang tertulis, pengeluaran impulsif sering kali tidak terkendali.",
    },
  },
  {
    id: 2,
    ...
    content: {
      intro:
        "Aturan Kebutuhan: Alokasikan anggaran untuk hal-hal yang benar-benar dibutuhkan untuk kehidupan sehari-hari.",
      methods: [
        {
          percent: "50%",
          label: "Kebutuhan",
          color: "#34D399",
          colorLight: "#D1FAE5",
          desc: "Kebutuhan: Belanjakan tidak lebih dari setengah penghasilan untuk kebutuhan pokok sehari-hari.",
        },
        {
          percent: "30%",
          label: "Keinginan",
          color: "#60A5FA",
          colorLight: "#DBEAFE",
          desc: "Keinginan: Sisihkan 3 dari 10 bagian penghasilan untuk menikmati hidup dan keinginan pribadi.",
        },
        {
          percent: "20%",
          label: "Tabungan",
          color: "#A78BFA",
          colorLight: "#EDE9FE",
          desc: "Tabungan: Prioritaskan minimal 2 dari 10 bagian untuk menabung dan berinvestasi demi masa depan.",
        },
      ],
    },
  },
  {
    ...
    content: {
      intro:
        "Arus kas adalah aliran uang masuk dan keluar dari keuangan Anda. Melacak arus kas secara rutin adalah kunci untuk memastikan Anda selalu berada di jalur yang benar secara finansial.",
      sectionTitle: null,
      items: [],
      paragraphs: [
      ...
      closing:
        "Dengan memahami arus kas Anda, Anda akan lebih mudah membuat keputusan keuangan yang bijak dan menghindari pengeluaran yang tidak perlu.",
    },
  },
];
          ...
          <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #E8ECF0", overflow: "hidden" }}>
            ...
            {slide.type === "text" && (
              <div style={{ padding: "1.75rem" }}>
                ...
                {slide.content.paragraphs && slide.content.paragraphs.map((p, i) => (
                  <p key={i} style={{ fontSize: 14, lineHeight: 1.8, color: "#374151", marginBottom: "1rem" }}>
                    {p}
                  </p>
                ))}

                {slide.content.closing && (
                  <div style={{ background: ACCENT_LIGHT, borderRadius: 8, padding: "1rem 1.25rem", borderLeft: `3px solid ${ACCENT}` }}>
                    <p style={{ fontSize: 14, lineHeight: 1.7, color: ACCENT_DARK, margin: 0 }}>
                      {slide.content.closing}
                    </p>
                  </div>
                )}
            ...
            {/* Slide 2 - Metode 50/30/20 */}
            {slide.type === "text-method" && (
              <div style={{ padding: "1.75rem" }}>
                <p style={{ fontSize: 14, lineHeight: 1.8, color: "#374151", marginBottom: "1.5rem" }}>
                  {slide.content.intro}
                </p>

                {/* Visual Bar 50/30/20 */}
                <div style={{ display: "flex", borderRadius: 10, overflow: "hidden", height: 28, marginBottom: "1.5rem" }}>
                  {slide.content.methods.map((m, i) => (
                    <div
                      key={i}
                      style={{
                        flex: parseInt(m.percent),
                        background: m.color,
                        display: "flex",
                        alignItems: "center",
